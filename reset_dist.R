...
# 
# {
#   match_lat <- match(round(device2$`150220249_LAT`, 2), round(origin_lat, 2)) |
#     match(round(device2$`150220249_LAT`, 2), 12.85)
#   
#   match_long <- match(round(device2$`150220249_LONG`, 2), round(origin_long, 2)) |
#     match(round(device2$`150220249_LONG`, 2), 77.67)
#   #print(match_lat)
#   #print(match_long)
#   
#   match_val <- match_lat & match_long
...
#     
#     if(!is.na(i)) #start of new trip
#       device2_dist <- c(device2_dist, 0)
#     #device1$`150219795_DISTANCE`[loop_cntr] <- 0
#     else{ 
#       x <- (device2$`150220249_LONG`[loop_cntr+1] - device2$`150220249_LONG`[loop_cntr])
#       y <- (device2$`150220249_LAT`[loop_cntr+1] - device2$`150220249_LAT`[loop_cntr])
#       
#       #print(x)
#       print(device2_dist[loop_cntr])
#       device2_dist <- c(device2_dist, device2_dist[loop_cntr] + euc.dist(x, y))
#       #device1$`150219795_DISTANCE`[loop_cntr] = device1$`150219795_DISTANCE`[loop_cntr-1]
#       #                                          + euc.dist(x, y)
#       print(device2_dist[loop_cntr+1])
#     }
#     device2_time <- c(device2_time, device2$`150220249_TIME_SECS`[loop_cntr])
#   }
#   
#   print(device2_dist)
#   print(length(device2_dist))
#   print(length(device2_time))
#   
#   #Plotting dist vs. time
#   plot(device2_time, device2_dist, 
#        ylab = "Distance device 2",xlab = "Time_secs")
#   
# }
